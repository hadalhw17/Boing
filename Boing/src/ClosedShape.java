...
public class ClosedShape {
	...
	protected ClosedShape (int insertionTime, int x, int y, int vx, int vy, Color colour, boolean isFilled, Color newColor, boolean flashing) {
		this.xPos = x;
		this.yPos = y;
		this.xVec = vx;
		this.yVec = vy;
		this.colour = colour;
		this.oldColor = colour;
	...
	public boolean getFlashed(){return flashing;}
 	/**
	...
	public void flash(boolean flashed){
		if(flashed){
			colour = newColor;
